...
british:!1,css:{display:"none"},position:{input:{v:"bottom",h:"left"},container:{v:"top",h:"left"}},display:{time:200,effect:"expand"},on:{select:!1,change:!1}},b),this.container=d("<div></div>",{attr:{"class":"ydatepicker-container radius__6"},css:this.settings.css}).appendTo("body"),d.each({date:[1,1],min:!1,max:!1},d.proxy(function(a,b){var d=!1;this.settings[a]&&(d=this._parseDate(this.settings[a]));d||"date"!==a||(d=this.input.val(),d=this._parseDate(d));!d&&b&&(d=this._parseDate(b));this.settings[a]=
d},this)),this.settings.min&&this.settings.max&&!this.settings.date.isBetween(this.settings.min,this.settings.max)&&(this.settings.max=!1),this.date=this.settings.date.clone(),this.currentDate=this.date.clone(),this.drawPicker(),f(this.settings.alt)&&this.setupAltField())},destroy:function(){this.input.attr("readonly",!1);this.container.remove()},drawPicker:function(){for(var a="<div class='ydatepicker-head noselect'>                            <div class='ydatepicker-head__inner radius__6 gradient__light'>                                <a class='ydatepicker-head__left' data-shift='-1'><svg id='simple-left' class='custom-icon' version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' viewBox='0 0 100 100'>                              <path class='inner-shape' transform='{{transform-rotate}}' d='M98.797,45.427H19.864l22.75-21.321H28.832L1.203,50l27.629,25.893h13.782l-22.75-21.32h78.933V45.427z'></path>                          </svg></a>                                <span class='ydatepicker-head__month'><strong>"+
this.date.getMonth("long")+"</strong></span>                                <a class='ydatepicker-head__right' data-shift='1'>"+"<svg id='simple-left' class='custom-icon' version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' viewBox='0 0 100 100'>                              <path class='inner-shape' transform='{{transform-rotate}}' d='M98.797,45.427H19.864l22.75-21.321H28.832L1.203,50l27.629,25.893h13.782l-22.75-21.32h78.933V45.427z'></path>                          </svg>".replace("{{transform-rotate}}",
"rotate(-180, 50, 50)")+"</a>                            </div>                        </div>                        <div class='ydatepicker-body noselect'>                            <div class='ydatepicker-body__inner'>                                <table>                                    <tr>",b=1;31>=b;b++)b-1&&1>(b-1)%7&&(a+="</tr><tr>"),a+="<td data-day='"+b+"'><a class='gradient__dark'>"+b+"</a></td>";this.container.html(a+"</tr>                                </table>                            </div>                        </div>");
this.setEvents();this.setInput()},setEvents:function(){this.container.find(".ydatepicker-head [data-shift]").on("click",d.proxy(this.onMonthShiftClick,this));this.container.find(".ydatepicker-head__left svg,.ydatepicker-head__right svg").hover(d.proxy(function(a){d(a.target).closest("svg").find("path").attr("fill","darkgrey")},this),d.proxy(function(a){d(a.target).closest("svg").find("path").attr("fill","black")},this));this.container.find(".ydatepicker-body td[data-day] a").on("click",d.proxy(this.onDaySelect,
